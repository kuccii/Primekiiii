...
const blogFeatureData = [
  {
    image: "/East_africa_trade.png",
    type: "Market Insight",
    header: "How East African grain trade flows across borders",
  ...
  {
    image: "/Africa_trade_construction_set-.png",
    type: "Logistics",
    header: "Coordinating ports, storage, and logistics for bulk commodities",
    info: "Society is fragmenting into two parallel realities. In one reality, you have infinite upside and opportunity. In the  other reality, you’ll continue to see the gap between your standard of living and those at the top grow more and more.",
  ...
  {
    image: "/Africa-trade-export-.png",
    type: "Export",
    header: "Export readiness: documents every serious exporter should track",
    info: "Society is fragmenting into two parallel realities. In one reality, you have infinite upside and opportunity. In the other reality, you’ll continue to see the gap between your standard of living and those at the top grow more and more.",
  ...
  {
    image: "/african_Trade.png",
    type: "Pipeline",
    header: "Turning informal leads into a structured deal pipeline",
    info: "Society is fragmenting into two parallel realities. In one reality, you have infinite upside and opportunity. In the other reality, you’ll continue to see the gap between your standard of living and those at the top grow more and more.",
  ...
  },
  {
    image: "/african_Trade.png",
    type: "Profiles",
    header: "What a strong trade profile looks like on QSource Network",
    info: "Society is fragmenting into two parallel realities. In one reality, you have infinite upside and opportunity. In the other reality, you’ll continue to see the gap between your standard of living and those at the top grow more and more.",
  ...
  },
  {
    image: "/East_africa_trade.png",
    type: "Risk",
    header: "Managing counterparty and quality risk in agricultural deals",
    info: "Society is fragmenting into two parallel realities. In one reality, you have infinite upside and opportunity. In the other reality, you’ll continue to see the gap between your standard of living and those at the top grow more and more.",
    profilePic: "/testimonial/6.jpg",
    author: "Donna Martin",
    data: "August 25, 2021",
  ...
  },
  {
    image: "/Africa_trade_construction_set-.png",
    type: "Compliance",
    header: "Navigating AfCFTA, phytosanitary, and export compliance",
    info: "Society is fragmenting into two parallel realities. In one reality, you have infinite upside and opportunity. In the other reality, you’ll continue to see the gap between your standard of living and those at the top grow more and more.",
    profilePic: "/testimonial/1.jpg",
    author: "Donna R. Book",
  ...
  },
  {
    image: "/Africa-trade-export-.png",
    type: "Finance",
    header: "How better documentation supports trade finance decisions",
    info: "Society is fragmenting into two parallel realities. In one reality, you have infinite upside and opportunity. In the other reality, you’ll continue to see the gap between your standard of living and those at the top grow more and more.",
    profilePic: "/testimonial/3.jpg",
  ...
  },
  {
    image: "/african_Trade.png",
    type: "Strategy",
    header: "Building a scalable export strategy for your agricultural business",
    info: "Society is fragmenting into two parallel realities. In one reality, you have infinite upside and opportunity. In the other reality, you’ll continue to see the gap between your standard of living and those at the top grow more and more.",
