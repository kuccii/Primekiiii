            ...
            <div className="row justify-content-between">
              <div className="col-md-8 col-lg-4 mb-md-4 mb-lg-0">
                <div className="footer-single-col">
                  ...
                  <p>
                    Stay informed about African agricultural trade trends, market insights, and platform updates. We'll send our monthly e-magazine and important trade information directly to your inbox.
                  </p>
