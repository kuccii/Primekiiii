...
const HeroSectionNine = () => {
       ...
       justify-content-center">
          <div className="col-lg-6 col-md-10 ">
            <div className="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
              ...
              <p className="lead">
              Source quality agricultural commodities from verified suppliers across Africa. Browse products, compare prices, and connect directly with trusted exporters.
              </p>
              <div className="action-btn mt-5 align-items-center d-block d-sm-flex d-lg-flex d-md-flex justify-content-center">
                <Link href="https://app.qivook.com/" >
                  <a  className="btn btn-primary me-3 ">Browse Suppliers</a>
                </Link>
  ...
  Export Your Products
              ...
              Reach buyers across Africa and beyond. List your agricultural products, showcase your quality, and connect with verified importers looking for your commodities.
              </p>
              <div className="action-btn mt-5 align-items-center d-block d-sm-flex d-lg-flex d-md-flex justify-content-center">
                <Link href="https://app.qivook.com" >
                  <a  className="btn btn-primary me-3">List Your Products</a>
                </Link>
               {/* <DarkModal className="true"/> */}
              </div>
            </div>
