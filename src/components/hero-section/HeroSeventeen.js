            ...
            <div className="mk-hero-content">
              ...
              <div className="d-flex align-items-center mk-btn-group flex-wrap">
                <Link href="https://app.qivook.com">
                  <a className="ins-btn mk-white-btn">Access QSource Network</a>
                </Link>
                <ModalVideo
                  channel="youtube"
                  isOpen={isOpen}
        ...
        <div className="row align-items-center justify-content-between">
          ...
          <div className="mk-title">
              ...
              <div className="d-flex align-items-center">
                <span className="subtitle fw-bold me-1 display-6 teal-text" style={{color: "#219C90"}} >QSource Network Marketplace</span>
                <span>
                  <svg
                    width="56"
                    height="13"
              ...
              Search Products & Find Verified Suppliers Across Africa
              </h2>
            </div>
          </div>
          <div className="col-xl-5">
