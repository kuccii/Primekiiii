          ...
          <div className="col-lg-6 col-md-12">
            <div className="p-3">
              ...
              <p className="mb-4">
                ...
                market intelligence including a monthly e-magazine on agricultural trade trends, and streamlined trade processes that reduce costs and accelerate growth.
              </p>
              <div>
                <Link href="/about-us">
